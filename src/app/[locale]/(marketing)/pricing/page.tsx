    ...
    <div className="mx-auto max-w-7xl px-4 py-16">
      ...
      <div className="mt-16 grid gap-8 md:grid-cols-2 lg:gap-12">
        ...
        <div className="rounded-2xl border-2 border-gray-200 p-8">
          ...
          <button type="button" className="mt-8 w-full rounded-lg bg-gray-200 py-3 font-semibold text-gray-600">
            Current Plan
          </button>
        </div>
...
function PricingPageGuest() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 text-center">
      <h1 className="text-4xl font-bold">Sign up to see pricing</h1>
      <p className="mt-4 text-lg text-gray-600">
        Create a free account to try the calculator
      </p>
      <Link
        href="/sign-up"
